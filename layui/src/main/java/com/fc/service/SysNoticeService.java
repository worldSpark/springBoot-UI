...
import com.fc.mapper.auto.SysNoticeMapper;
import com.fc.mapper.auto.SysNoticeUserMapper;
...
public class SysNoticeService implements BaseService<SysNotice, SysNoticeExample>{
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser, Tablepar tablepar, String name){
			...
			SysNoticeUserExample.Criteria criteria= sysNoticeUserExample.createCriteria();
