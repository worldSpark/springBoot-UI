package com.fc.common.conf.redis;
...
public class RedisService {
     ...
     * @param key
     */
    public void removeLeft(final String key)
    {
     ...
     * @param key
     */
    public void removeRight(final String key)
    {
    ...
    public List<String> getMultiGet(final Collection<String> keys){
